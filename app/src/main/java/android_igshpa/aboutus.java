...
public class aboutus extends Activity {
    ...
    private void openURL() {
        webview.loadUrl("http://www.igshpa.org/about-us");
    ...
    public  boolean checkConnection(Context context) {
        ...
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(aboutus.this);
