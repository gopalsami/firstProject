...
public class directory extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("IGSHPA Directory");
    ...
    private void openURL() {
        webview.loadUrl("http://igshpa.org/directory");
    ...
    public  boolean checkConnection(Context context) {
        ...
        android.app.AlertDialog.Builder alertDialog = new android.app.AlertDialog.Builder(directory.this);
